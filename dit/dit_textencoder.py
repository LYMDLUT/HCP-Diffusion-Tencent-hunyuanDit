...
import torch
from hcpdiff.models.compose.compose_textencoder import ComposeTextEncoder
from transformers.modeling_outputs import BaseModelOutputWithPooling

class DiTComposeTextEncoder(ComposeTextEncoder):
    def forward(
        self,
        ...
        input_ids_list = [input_ids[...,:77], input_ids[...,77:]]
        attention_mask_list = [attention_mask[...,:77], attention_mask[...,77:]]
        if self.with_hook:
            encoder_hidden_states_list, pooled_output_list = [], []
            for name, input_ids, attention_mask in zip(self.model_names, input_ids_list, attention_mask_list):
            ...
            if text_feat_list['hidden_states'][0] is None:
                ...
                hidden_states = [states for states in zip(*text_feat_list['hidden_states'])]
